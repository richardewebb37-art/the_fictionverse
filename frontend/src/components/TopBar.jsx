      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="relative">
            ...
            {isMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-[#0a1525]/95 backdrop-blur-md border border-border/30 rounded-lg shadow-lg py-2 animate-in slide-in-from-top-2 duration-200">
                {isLoggedIn && user && (
